...
function myProductData(shText="",colSort=1,rawSort=true,page=1,perPage=10){
...
function showProductTable(per=10, p=1, colSort=1, rawSort=true) { //======================== แสดงตาราง
  var strSearch = document.getElementById('search_product').value;
  var n = ((p - 1) * per);
    const myArr = myProductData(strSearch,colSort,rawSort,p,per);
